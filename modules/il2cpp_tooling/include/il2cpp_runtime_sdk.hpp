...
#ifndef FC_IL2CPP_THREAD_DETACH_ON_DESTROY
#define FC_IL2CPP_THREAD_DETACH_ON_DESTROY 0
#endif
...
#if FC_IL2CPP_THREAD_DETACH_ON_DESTROY
        thread_detach_ = reinterpret_cast<void (*)(void*)>(
            GetProcAddress(il2cpp.handle(), "il2cpp_thread_detach"));
#endif
...
#if FC_IL2CPP_THREAD_DETACH_ON_DESTROY
        , thread_detach_(other.thread_detach_)
#endif
    {
        other.thread_ = nullptr;
#if FC_IL2CPP_THREAD_DETACH_ON_DESTROY
        other.thread_detach_ = nullptr;
#endif
    }
...
#if FC_IL2CPP_THREAD_DETACH_ON_DESTROY
    void detach() {
        if (thread_ && thread_detach_) {
            thread_detach_(thread_);
        }
        thread_ = nullptr;
    }
#endif
