...
cl /nologo /std:c++20 /EHsc /W4 /DWIN32_LEAN_AND_MEAN /DNOMINMAX ^
  action_controller.cpp ^
  /Fo:..\build\ ^
  /Fe..\build\il2cpp_action_controller_rig_power.exe ^
  user32.lib gdi32.lib shell32.lib ole32.lib comctl32.lib
